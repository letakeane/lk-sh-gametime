...
describe ('Snake', function() {
  ...
  it.skip('should begin moving right on right arrow click event', function() {
    var snake = new Snake();
    assert.equal(snake.x, x++)
  });

  it.skip('should begin moving left on left arrow click event', function() {
    var snake = new Snake();
    assert.equal(snake.x, x--)
  });

  it.skip('should begin moving up on up arrow click event', function() {
    var snake = new Snake();
    assert.equal(snake.y, y--)
  });

  it.skip('should begin moving down on down arrow click event', function() {
    var snake = new Snake();
    assert.equal(snake.y, y++)
  });
})
